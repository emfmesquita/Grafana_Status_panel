...
This is the [original repo](https://github.com/Vonage/Grafana_Status_panel) with two small changes:

* Bug fix on panel links for new versions of grafana (change of properties used from links);
